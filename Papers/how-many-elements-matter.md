...
citekey: how-many-elements-matter
...
### 2.3 Observational uncertainties in abundance measurements
...
### 4.2 The baseline: conditioning on Fe and Mg

### 4.3 Dispersion alone cannot (yet) detect independent elements

### 4.4.1 Statistical covariances from the aspcap measurements

### 4.4 APOGEE data demonstrate residual correlation structure between elemental abundances

### 4.4.2 Correlation estimation uncertainty from finite sampling

### 4.4.3 Abundance measurement aberration

### 4.5 Many APOGEE elemental abundances contain independent information

### 5 Discussion

### 5.1 Characterizing dimensionality and the stochastic chemical evolution of the Milky Way

### 5.2 Nucleosynthesis Implications

### 5.3 Characterizing observational uncertainties

### 5.4 Chemical outliers, chemical siblings, and chemical doppelgangers

### 5.5 Implications for Survey Design

### 6 Conclusions

### Appendix A Conditioning on different Teff and logg

### Appendix B Can mischaracterization of the ASPCAP photon noise explain the correlation signals?
